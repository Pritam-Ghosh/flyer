            ...
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="design-area">
                  <textarea
                    className=""
                 style={{ fontSize: `${textSize}px`, textAlign: alignment }}
                  />
                </div>
              ...
              <div className="col-lg-4">
                <div className="d-flex align-items-start">
                  <div className="nav flex-column nav-pills me-3 bg-light" id="v-pills-tab" role="tablist" aria-orientation="vertical">
